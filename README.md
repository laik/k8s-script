...
> kubeadm init --apiserver-advertise-address=192.168.5.107 --kubernetes-version=v1.10.1 --pod-network-cidr=10.244.0.0/16
...
>> 删除 /etc/systemd/system/kubelet.service.d/10-kubeadm.conf 中的$ KUBELET_NETWORK_ARGS 
...
加入后面 --runtime-cgroups=/systemd/system.slice --kubelet-cgroups=/systemd/system.slice 这一段
